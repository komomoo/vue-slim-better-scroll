...
exports.default = _default;
},{}],"../../dist/vue-slim-better-scroll.esm.min.js":[function(require,module,exports) {
"use strict";
...
var e,
  ...
  !function (e) {
    ...
    if (u) t.exports = u;else {
      (u = e.regeneratorRuntime = t.exports).wrap = A;
      ...
      var y = Object.getPrototypeOf,
          m = y && y(y(E([])));
      m && m !== r && i.call(m, l) && (w = m);
      var v = C.prototype = b.prototype = Object.create(w);
      x.prototype = v.constructor = C, C.constructor = x, C[a] = x.displayName = "GeneratorFunction", u.isGeneratorFunction = function (t) {
        var e = "function" == typeof t && t.constructor;
        return !!e && (e === x || "GeneratorFunction" === (e.displayName || e.name));
      }, u.mark = function (t) {
        return Object.setPrototypeOf ? Object.setPrototypeOf(t, C) : (t.__proto__ = C, a in t || (t[a] = "GeneratorFunction")), t.prototype = Object.create(v), t;
      }, u.awrap = function (t) {
        return {
          __await: t
        };
      }, D(R.prototype), R.prototype[s] = function () {
        return this;
      }, u.AsyncIterator = R, u.async = function (t, e, n, r) {
        var i = new R(A(t, e, n, r));
        return u.isGeneratorFunction(e) ? i : i.next().then(function (t) {
          return t.done ? t.value : i.next();
        });
      }, D(v), v[a] = "Generator", v[l] = function () {
        return this;
      }, v.toString = function () {
        return "[object Generator]";
      }, u.keys = function (t) {
        ...
        dispatchException: function dispatchException(t) {
          ...
          for (var o = this.tryEntries.length - 1; o >= 0; --o) {
            ...
            if (l.tryLoc <= this.prev) {
              var a = i.call(l, "catchLoc"),
                  u = i.call(l, "finallyLoc");
        ...
        abrupt: function abrupt(t, e) {
          ...
          return l.type = t, l.arg = e, o ? (this.method = "next", this.next = o.finallyLoc, f) : this.complete(l);
        },
      ...
      return o._invoke = function (t, e, n) {
        ...
        return function (i, o) {
          ...
          for (n.method = i, n.arg = o;;) {
            ...
            if ("normal" === a.type) {
              if (r = n.done ? d : h, a.arg === f) continue;
              return {
                value: a.arg,
                done: n.done
              };
          ...
          return new Promise(function (e, o) {
            !function e(n, r, o, l) {
              ...
              if ("throw" !== s.type) {
                var a = s.arg,
                    u = a.value;
                return u && "object" == (0, _typeof2.default)(u) && i.call(u, "__await") ? Promise.resolve(u.__await).then(function (t) {
                  e("next", t, o, l);
                }, function (t) {
                  e("throw", t, o, l);
    ...
    function U(t, e) {
      ...
      if (r === n) {
        if (e.delegate = null, "throw" === e.method) {
          if (t.iterator.return && (e.method = "return", e.arg = n, U(t, e), "throw" === e.method)) return f;
      ...
      var i = g(r, t.iterator, e.arg);
      if ("throw" === i.type) return e.method = "throw", e.arg = i.arg, e.delegate = null, f;
      var o = i.arg;
      return o ? o.done ? (e[t.resultName] = o.value, e.next = t.nextLoc, "return" !== e.method && (e.method = "next", e.arg = n), e.delegate = null, f) : o : (e.method = "throw", e.arg = new TypeError("iterator result is not an object"), e.delegate = null, f);
    }
...
var l = n;
if (i) r.regeneratorRuntime = o;else try {
...
var u = function u(t) {
  return function () {
    ...
    _c = "vue-slim-better-scroll",
    h = {
  methods: {
    c: function c(t) {
      return t ? "".concat(_c).concat(t) : "".concat(_c);
    }
  }
},
    p = {
...
var d = function d(t, e, n, r, i, o, l, s, a, u) {
  "boolean" != typeof l && (a = s, s = l, l = !1);
  var c,
      h = "function" == typeof n ? n.options : n;
  if (t && t.render && (h.render = t.render, h.staticRenderFns = t.staticRenderFns, h._compiled = !0, i && (h.functional = !0)), r && (h._scopeId = r), o ? (c = function c(t) {
  ...
  }, h._ssrRegister = c) : e && (c = l ? function () {
    ...
    return function (t, e) {
      ...
      if (!r.ids.has(t)) {
        ...
        if (e.map && (i += "\n/*# sourceURL=" + e.map.sources[0] + " */", i += "\n/*# sourceMappingURL=data:application/json;base64," + btoa(unescape(encodeURIComponent(JSON.stringify(e.map)))) + " */"), r.element || (r.element = document.createElement("style"), r.element.type = "text/css", e.media && r.element.setAttribute("media", e.media), w.appendChild(r.element)), "styleSheet" in r.element) r.styles.push(i), r.element.styleSheet.cssText = r.styles.filter(Boolean).join("\n");else {
          ...
          s[o] && r.element.removeChild(s[o]), s.length ? r.element.insertBefore(l, s[o]) : r.element.appendChild(l);
        }
      }
    }(t, e);
  };
...
var v = d({
  render: function render() {
    var t = this.$createElement,
        e = this._self._c || t;
    return e("div", {
      class: this.c("-loading-container")
    }, [e("img", {
      attrs: {
  ...
  t && t("data-v-30eba643_0", {
    source: ".vue-slim-better-scroll-loading-container>img{width:20px;height:20px;display:block}",
    map: void 0,
    media: void 0
  });
}, p, void 0, !1, void 0, m, void 0);
var A = d({
  render: function render() {
    var t = this.$createElement;
  ...
  methods: {
    ...
    _drawBubble: function _drawBubble(t) {
      t.save(), t.beginPath();
      ...
      t.quadraticCurveTo(l.x, l.y, o.x, o.y), t.arc(i.x, i.y, r, Math.PI, 0, !0);
      var s = {
      ...
      t.quadraticCurveTo(a.x, a.y, s.x, s.y), t.fillStyle = "rgb(170,170,170)", t.fill(), t.strokeStyle = "rgb(153,153,153)", t.stroke(), t.restore();
    },
    _drawArrow: function _drawArrow(t) {
      t.save(), t.beginPath();
      var e = this.distance / this.maxDistance,
...
var b = d({
  render: function render() {
    ...
    return n("div", {
      ...
      ref: "scrollContent"
    }, [t._t("default")], 2), t._v(" "), t._t("pullup", [t.pullUp ? n("div", {
      class: t.c("__pullup")
    }, [t.pullUpNow ? n("div", [n("Loading")], 1) : n("div", [n("span", [t._v(t._s(t.pullUpTxt))])])]) : t._e()], {
      pullUp: t.pullUp,
      pullUpNow: t.pullUpNow
    })], 2), t._v(" "), t._t("pulldown", [t.pullDown ? n("div", {
      ref: "pulldown",
      class: t.c("__pulldown"),
      style: t.pullDownStyle
    }, [t.pullDownBefore ? n("div", {
      class: t.c("__pulldown__before")
    }, [n("Bubble", {
      attrs: {
        y: t.bubbleY
      }
    })], 1) : n("div", {
      class: t.c("__pulldown__after")
    }, [t.pullDownNow ? n("div", [n("Loading")], 1) : n("div", [n("span", [t._v(t._s(t.pullDownTxt))])])])]) : t._e()], {
      pullDown: t.pullDown,
      pullDownStyle: t.pullDownStyle,
      pullDownBefore: t.pullDownBefore,
      pullDownNow: t.pullDownNow,
      bubbleY: t.bubbleY
    })], 2);
  },
  staticRenderFns: []
}, function (t) {
  t && t("data-v-5df5f50b_0", {
  ...
  computed: {
    ...
    pullUpTxt: function pullUpTxt() {
      var t = this.pullUpConfig && this.pullUpConfig.txt && this.pullUpConfig.txt.more,
          e = this.pullUpConfig && this.pullUpConfig.txt && this.pullUpConfig.txt.noMore;
      return this.pullUpFinally ? e : t;
    }
  },
  watch: {
    ...
    var t = u(s.mark(function t() {
      ...
      return s.wrap(function (t) {
        for (;;) {
          switch (t.prev = t.next) {
            case 0:
              return this.pullDownInitTop = parseInt(this.$refs.pulldown && getComputedStyle(this.$refs.pulldown).top) || -50, t.next = 3, this.$nextTick();

            case 3:
              this.initScroll(), this.autoUpdate && this.$parent && this.$parent.$data && this.$watch(function () {
  ...
  methods: {
    initScroll: function initScroll() {
      ...
      if (this.$refs.scroll) {
        this.$refs.scrollContent && (this.$refs.scrollContent.style.minHeight = "".concat(this.$refs.scroll.getBoundingClientRect().height + 1, "px"));
        var n = {
        ...
        this.scroll = new _betterScroll.default(this.$refs.scroll, n), this.listenScroll && this.scroll.on("scroll", function (t) {
          e.$emit("scroll", t);
        }), this.listenBeforeScrollStart && this.scroll.on("beforeScrollStart", function () {
          e.$emit("beforeScrollStart");
        }), this.pullDown && this._initPullDown(), this.pullUp && this._initPullUp();
      }
    },
    _initPullDown: function _initPullDown() {
      var t = this;
      this.scroll.on("pullingDown", function () {
        t.pullDownBefore = !1, t.pullDownNow = !0, t.$emit("pullingDown"), t.scroll.closePullDown();
      }), this.scroll.on("scroll", function (e) {
        if (t.pullDown && !(e.y < 0)) {
          var n = Math.floor(e.y);
          t.pullDownBefore ? (t.bubbleY = Math.max(0, n + t.pullDownInitTop), t.pullDownStyle = "transform: translateY(".concat(Math.min(n, -t.pullDownInitTop), "px)")) : t.bubbleY = 0, t.isRebounding && (t.pullDownStyle = "transform: translateY(".concat(Math.min(n, t.pullDownConfig.stop), "px)"));
        }
      });
    },
    _initPullUp: function _initPullUp() {
      ...
      this.scroll.on("pullingUp", function () {
        t.pullUpFinally ? t.scroll.finishPullUp() : (t.pullUpNow = !0, t.$emit("pullingUp"));
      });
    },
        ...
        return s.wrap(function (t) {
          for (;;) {
            switch (t.prev = t.next) {
              ...
              case 3:
                return this.pullDownUpdateState = !0, this.pullDownNow = !1, t.next = 7, g(this.bounceTime / 2);

              case 7:
                return this.isRebounding = !0, this.scroll.finishPullDown(), t.next = 11, g(this.bounceTime);

              case 11:
                this.pullDownBefore = !0, this.isRebounding = !1, this.scroll.openPullDown(this.pullDownConfig), this.pullUpFinally = !1, t.next = 23;
                break;
              ...
              case 20:
                this.pullUpUpdateState = !0, this.pullUpNow = !1, this.scroll.finishPullUp();

              case 23:
                return void 0 !== e && (this.pullUpFinally = !!e), t.next = 26, this.$nextTick();

              case 26:
                this.refresh(), this.pullDownUpdateState = !1, this.pullUpUpdateState = !1;
    ...
    scrollTo: function scrollTo() {
      var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 0,
          ...
          n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : this.bounceTime;
      this.scroll && this.scroll.scrollTo(t, e, n);
    },
...
var _default = b;
exports.default = _default;
},{"@babel/runtime/helpers/typeof":"../../node_modules/@babel/runtime/helpers/typeof.js","better-scroll":"../../node_modules/better-scroll/dist/bscroll.esm.js"}],"../../src/Scroll/utils/index.js":[function(require,module,exports) {
"use strict";
...
var _vueSlimBetterScrollEsmMin = _interopRequireDefault(require("../../dist/vue-slim-better-scroll.esm.min.js"));

var _utils = require("../../src/Scroll/utils");
...
var _default = {
  name: 'App',
  components: {
    Scroll: _vueSlimBetterScrollEsmMin.default
  },
  data: function data() {
    return {
      list: []
...
exports.default = _default;
        var $5f3922 = exports.default || module.exports;
      
      if (typeof $5f3922 === 'function') {
        $5f3922 = $5f3922.options;
      }
    
        /* template */
        Object.assign($5f3922, (function () {
          var render = function() {
  var _vm = this
  ...
  return _c(
    ...
    [
      ...
      false
        ? _c(
            "Scroll",
            {
              ref: "scroll",
              staticClass: "content",
              attrs: { "update-data": [_vm.list], "refresh-data": [] },
              on: { pullingDown: _vm.loadRefresh, pullingUp: _vm.loadMore }
            },
            [
              _c(
      ...
      _c(
        "footer",
        { staticClass: "footer", on: { click: _vm.scrollToBottom } },
        [_vm._v("点我回到底部")]
      )
    ],
    1
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$5f3922', $5f3922);
          } else {
            api.reload('$5f3922', $5f3922);
          }
        }
...
},{"@babel/runtime/helpers/toConsumableArray":"../../node_modules/@babel/runtime/helpers/toConsumableArray.js","@babel/runtime/regenerator":"../../node_modules/@babel/runtime/regenerator/index.js","@babel/runtime/helpers/asyncToGenerator":"../../node_modules/@babel/runtime/helpers/asyncToGenerator.js","../../dist/vue-slim-better-scroll.esm.min.js":"../../dist/vue-slim-better-scroll.esm.min.js","../../src/Scroll/utils":"../../src/Scroll/utils/index.js","_css_loader":"../../node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"../../node_modules/vue-hot-reload-api/dist/index.js","vue":"../../node_modules/vue/dist/vue.runtime.esm.js"}],"main.js":[function(require,module,exports) {
"use strict";
