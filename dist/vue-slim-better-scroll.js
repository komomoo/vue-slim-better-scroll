/**
 * vue-slim-better-scroll v1.6.0
 * Copyright (c) 2018-present, momoko <ko.momo@qq.com>
 * Released under the MIT License.
 */

(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('better-scroll')) :
	typeof define === 'function' && define.amd ? define(['better-scroll'], factory) :
	(global = global || self, global['vue-slim-better-scroll'] = factory(global.BScroll));
}(this, function (BScroll) { 'use strict';
	...
	/* template */
	var __vue_render__ = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{class:_vm.c('__loading')},_vm._l((12),function(item){return _c('i',{key:item})}),0)};
	var __vue_staticRenderFns__ = [];

	  /* style */
	  const __vue_inject_styles__ = function (inject) {
	    if (!inject) return
	    inject("data-v-9479dd72_0", { source: ".vue-slim-better-scroll__loading{width:20px;height:20px;position:relative;display:block;box-sizing:border-box;animation:spinner-rotate 1s linear infinite;animation-timing-function:steps(12);color:#8c8c8c}.vue-slim-better-scroll__loading i{top:0;left:0;width:100%;height:100%;position:absolute}.vue-slim-better-scroll__loading i::before{width:9%;height:25%;content:'';display:block;margin:0 auto;border-radius:10px;background-color:currentColor}.vue-slim-better-scroll__loading i:nth-of-type(1){opacity:1;transform:rotate(30deg)}.vue-slim-better-scroll__loading i:nth-of-type(2){opacity:.9375;transform:rotate(60deg)}.vue-slim-better-scroll__loading i:nth-of-type(3){opacity:.875;transform:rotate(90deg)}.vue-slim-better-scroll__loading i:nth-of-type(4){opacity:.8125;transform:rotate(120deg)}.vue-slim-better-scroll__loading i:nth-of-type(5){opacity:.75;transform:rotate(150deg)}.vue-slim-better-scroll__loading i:nth-of-type(6){opacity:.6875;transform:rotate(180deg)}.vue-slim-better-scroll__loading i:nth-of-type(7){opacity:.625;transform:rotate(210deg)}.vue-slim-better-scroll__loading i:nth-of-type(8){opacity:.5625;transform:rotate(240deg)}.vue-slim-better-scroll__loading i:nth-of-type(9){opacity:.5;transform:rotate(270deg)}.vue-slim-better-scroll__loading i:nth-of-type(10){opacity:.4375;transform:rotate(300deg)}.vue-slim-better-scroll__loading i:nth-of-type(11){opacity:.375;transform:rotate(330deg)}.vue-slim-better-scroll__loading i:nth-of-type(12){opacity:.3125;transform:rotate(360deg)}@-moz-keyframes spinner-rotate{from{transform:rotate(0)}to{transform:rotate(360deg)}}@-webkit-keyframes spinner-rotate{from{transform:rotate(0)}to{transform:rotate(360deg)}}@-o-keyframes spinner-rotate{from{transform:rotate(0)}to{transform:rotate(360deg)}}@keyframes spinner-rotate{from{transform:rotate(0)}to{transform:rotate(360deg)}}", map: undefined, media: undefined });
